...
3. Specify how you want to upload the schema:
   ...
   2. **Paste schema content into a new schema.**
      ...
      3. You can either paste the contents of your schema directly into the code view or use the Editor view to build your schema using the controls provided. For information on the components of the Schema Editor, see [#editing-schema-details-using-the-editor](editing-schemas.md#editing-schema-details-using-the-editor "mention").
      4. Once your schema is ready, click **Save** to return to the Import Schema modal.
      5. Click **Import**.
   3. **Import a schema that already exists in Koodisi.**
