...
1. Click **Create Credentials** in the Credential Manager page.\
...
You can also create Git credentials on the fly when you create a Git application. For details on doing so, see [creating-a-git-enabled-application.md](/docs/using-git-to-develop-applications/creating-a-git-enabled-application) **> Use new credentials**.
