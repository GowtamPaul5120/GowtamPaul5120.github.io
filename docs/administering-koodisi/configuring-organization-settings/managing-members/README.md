...
1. You must first [invite a user](/docs/administering-koodisi/configuring-organization-settings/managing-members/inviting-users) to your organization and assign them roles that determine their ability to perform tasks.&#x20;
2. Once users join, you can refine their [access permissions](/docs/administering-koodisi/configuring-organization-settings/managing-members/managing-member-permissions-at-the-organization-level).
3. You can also assign users to teams to grant them team-based permissions.
