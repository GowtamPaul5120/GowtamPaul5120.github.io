...
2. Select **Add Git to Application**.\
   The Add Git to Application modal appears.
3. Enter relevant details as appropriate. For guidance on these details, see [creating-a-git-enabled-application.md](/docs/using-git-to-develop-applications/creating-a-git-enabled-application).
