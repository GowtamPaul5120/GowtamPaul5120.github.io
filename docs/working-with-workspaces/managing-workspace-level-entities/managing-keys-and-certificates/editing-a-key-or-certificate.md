...
3. Click the **Environment** field and, from the drop-down list that appears, select additional environments in which the key or certificate must be available.\
   \
   To remove an environment from the list, click the **X** icon that appears on its right.
4. Click **Save**.
