...
Create public workspaces to provide your team a shared space where they can experiment with different kinds of workflows and learn how to use Koodisi.

### Private Workspaces

Use private workspaces to ensure that only designated team members have access to create and maintain production-ready workflows.
