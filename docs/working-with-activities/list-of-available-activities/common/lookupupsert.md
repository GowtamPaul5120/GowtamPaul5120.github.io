...
## Configuring the Lookup Upsert Activity

To configure the **Lookup Upsert** activity, fill in the required fields in the activity panel.
...
| Num Entries Upserted | Optional | Integer |  |  |
