...
export default function EditThisPage(): React.ReactElement {
  ...
  const getEditUrl = () => {
    const baseUrl = siteConfig.customFields?.editUrl as string;
  ...
  return (
    <div className="koodisi-edit-this-page">
      ...
      <div className="edit-instructions">
        <p>
          <strong>How to edit:</strong> Click the button above to open this page
          in GitHub. Make your changes and create a pull request. Your changes
          will be reviewed and merged automatically if they pass the checks.
        </p>
      </div>
    </div>
  );
